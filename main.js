const pizzaTypes = ["Pepperonni","Sausage", "Supreme", "Taco", "Ham", "Cheese"];
const pizzaCost = [11.50,11.50,14.50,12.50,10.50, 9.50];
...
function setUpPage()
{
    for(var i = 0; i < pizzaTypes.length; i++) {
        var option = document.createElement("option");
        var temp = pizzaTypes[i] + "  " + "$" + pizzaCost[i].toFixed(2);
        console.log(temp);
        option.value = i;
